                            ...
                            <div class="table-responsive">
                                <table id="refEvaluasiRapat" class="table table-bordered table-striped table-hover js-basic-example dataTable round_edge">
                                    ...
                                    <tbody>
                                        ...
                                        <?php } 
                                             echo "<div class='alert alert-warning' id='round'>Evaluasi Untuk Rapat Pada Tanggal <font size='5'>".$idToRapat['0']['rapat_tanggal']."</font></div>";
                                        ?>
                ...
                success: function() {
                    Swal.fire({
                      ...
                      timer: 1500
                        ...
                        $('#refEvaluasiRapat').load(document.URL +  ' #refEvaluasiRapat');
                    })     
                }
            });
