                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="header">
                            ...
                            <div class="row">
                                <form method="POST" class="formRapat" onsubmit="return submit_rapat()">
                                    <div class="col-lg-4">
                                        <input class="form-control" type="date" name="rapat_tanggal" required>
                                    </div>
                                    <div class="col-lg-6">
                                        <input class="form-control" type="text" name="rapat_deskripsi" placeholder="Keterangan" required>
                                    </div>
                    ...
                    <div class="body" id="refJadwalRapat">
                        <?php foreach ($jadwal_rapat as $jadwal) { ?>
                            <div class="card" id="round">
                                <div class="body row">
                                    <div class="col-lg-3"><i class="material-icons">date_range</i>
                                                ...
                                                <?php
                                                 ...
                                                 <?php }
                                                    ...
                                                    <div class="bg-pink" style="padding: 5px; width: auto" id="round">
                                                        <i class="material-icons">av_timer</i><?php echo "$days hari $hours jam lagi";  ?>
                                                    </div>
                                                    <?php } ?>
                                            </div>
                                            <div class="col-lg-12">
